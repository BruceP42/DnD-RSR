// ---------------------------------------------------------
// Path:         pipeline/data/raw/magic-items-SRD14.js
// File:         magic-items-SRD14.js
// Version:      V1.0
// Data Schema:  V1.1
// System:       DnD-RSR — D&D 5e Dynamic Reference System
// Module/Role:  Raw magic item dataset — SRD 5.1 content only.
//               Input to the pipeline normalize stage.
//               All 361 entries sourced exclusively from the
//               System Reference Document 2014 (SRD 5.1).
// Created:      2026-05-24
// Changelog:
//   V1.0: Initial version for DnD-RSR public repository.
...
export default [
  ...
  },
  {
    ...
    desc: [
      ...
      "As Daern's Instant Fortress in the DMG 2014",
    ],
    sources: [
      {
        source: "srd14",
