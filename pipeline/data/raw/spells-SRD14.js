// ---------------------------------------------------------
// Path:         pipeline/data/raw/spells-SRD14.js
// File:         spells-SRD14.js
// Version:      V2.0
// Data Schema:  V1.1
// System:       DnD-RSR — D&D 5e Dynamic Reference System
// Module/Role:  Raw spell dataset — SRD 5.1 content only.
//               Input to the pipeline normalize stage.
//               All 318 entries sourced from the System
//               Reference Document 2014 (SRD 5.1).
//               PHB page references in the sources array are
//               bibliographic cross-references only — they
//               indicate where the spell also appears in the
//               Player's Handbook for user convenience.
// Created:      2026-05-24
// Changelog:
//   V2.0: Header added for DnD-RSR public repository.
//         All entries verified as SRD 5.1 content.
//   V2.0 (sandbox): PHB page references added to sources array.
//   V1.0 (sandbox): Initial creation.
//
// Copyright notice:
//   The System Reference Document 5.1 is published by Wizards
//   of the Coast under the Creative Commons Attribution 4.0
//   International licence (CC-BY 4.0).
//   https://creativecommons.org/licenses/by/4.0/
//   This file may be freely used, modified, and redistributed
//   with attribution to Wizards of the Coast.
// ---------------------------------------------------------
...
export default [
    ...
    desc: [
      ...
      "Also known as Melf's Acid Arrow in the 2014 Player's Handbook",
    ],
    classes: [
      "Wizard",
    ],
  ...
  },
  {
    ...
    "sources": [
      {
        "source": "System Reference Document 2014",
        "page": null
      },
      {
